...
const initialParts: PartItem[] = [
  ...
  { id: "bolt_nuts", label: "BOLT & NUTS", price: 0, quantity: 0 },
  ...
  { id: "clutch_liver", label: "CLUTCH LIVER", price: 0, quantity: 0 },
  { id: "clutch_nut", label: "CLUTCH NUT", price: 0, quantity: 0 },
  { id: "clutch_packing", label: "CLUTCH PACKING", price: 0, quantity: 0 },
  { id: "clutch_plate", label: "CLUTCH PLATE", price: 0, quantity: 0 },
  { id: "coil_score", label: "COIL SCORE", price: 0, quantity: 0 },
  { id: "cylinder_packing", label: "CYLINDER PACKING", price: 0, quantity: 0 },
  { id: "dl_blub", label: "DL BLUB", price: 0, quantity: 0 },
  { id: "dl_pin", label: "DL PIN", price: 0, quantity: 0 },
  { id: "dim_bright_switch", label: "DIM BRIGHT SWITCH", price: 0, quantity: 0 },
  { id: "drump_bolt", label: "DRUMP BOLT", price: 0, quantity: 0 },
  { id: "et_coil", label: "ET COIL", price: 0, quantity: 0 },
  { id: "flasher", label: "FLASHER", price: 0, quantity: 0 },
  { id: "float", label: "FLOAT", price: 0, quantity: 0 },
  ...
  { id: "head_gas_set", label: "HEAD GAS SET", price: 0, quantity: 0 },
  { id: "head_nut", label: "HEAD NUT", price: 0, quantity: 0 },
  { id: "head_setting", label: "HEAD SETTING", price: 0, quantity: 0 },
  ...
  { id: "ind_switch", label: "IND SWITCH", price: 0, quantity: 0 },
  { id: "injector_bush", label: "INJECTOR BUSH", price: 0, quantity: 0 },
  { id: "injector_labour", label: "INJECTOR LABOUR", price: 0, quantity: 0 },
  { id: "kicker_bush", label: "KICKER BUSH", price: 0, quantity: 0 },
  { id: "kicker_lock", label: "KICKER LOCK", price: 0, quantity: 0 },
  { id: "kicker_wheel", label: "KICKER WHEEL", price: 0, quantity: 0 },
  ...
  { id: "mount_screw", label: "MOUNT SCREW", price: 0, quantity: 0 },
  { id: "needle", label: "NEEDLE", price: 0, quantity: 0 },
  ...
  { id: "sci_packing", label: "SCI PACKING", price: 0, quantity: 0 },
  ...
  { id: "top_horring", label: "TOP HORRING", price: 0, quantity: 0 },
  { id: "valve", label: "VALVE", price: 0, quantity: 0 },
  { id: "valve_guide", label: "VALVE GUIDE", price: 0, quantity: 0 },
  { id: "valve_lock", label: "VALVE LOCK", price: 0, quantity: 0 },
  { id: "valve_oil_seal", label: "VALVE OIL SEAL", price: 0, quantity: 0 },
  { id: "vaser", label: "VASER", price: 0, quantity: 0 },
